...
class FormaPagamentoList extends TPage
{
    ...
    private static $formName = 'formList_FormaPagamento';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de formas pagamentos");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['FormaPagamentoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('FormaPagamentoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FormaPagamentoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Formas pagamentos']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new FormaPagamento($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for FormaPagamento
