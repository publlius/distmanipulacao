...
class FarmaciaList extends TPage
{
    ...
    private static $activeRecord = 'Farmacia';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Farmacia';
    ...
    public function __construct()
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['FarmaciaForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('FarmaciaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FarmaciaList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Farmácias']));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Farmacia
