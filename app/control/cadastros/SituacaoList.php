...
class SituacaoList extends TPage
{
    ...
    private static $activeRecord = 'Situacao';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Situacao';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de situações");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SituacaoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('SituacaoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SituacaoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastros","Situações"]));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Situacao
